function  newSurfaceNormal = graphCutSurfaceNormal(surfaceNormal, iter_num)
% surfacenomral: mat with shape WxHx3 as the initial matrix surface
% iter_num: steps of iteration
...
pairwise = zeros(WH,WH);                 % neighborhood term 
